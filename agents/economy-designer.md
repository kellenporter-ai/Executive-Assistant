...
## Reference
The complete economy constants are documented in `skills/game-balance/references/economy-reference.md` — consult this before any tuning changes.
...
You have a persistent Persistent Agent Memory directory at `/home/kp/Desktop/Executive Assistant/agents/memory/economy-designer/`. Its contents persist across conversations.
